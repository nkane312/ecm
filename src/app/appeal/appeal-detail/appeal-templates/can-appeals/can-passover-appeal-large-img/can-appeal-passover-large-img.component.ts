...
@Component({
  selector: 'app-can-passover-large-img-appeal',
  templateUrl: './can-appeal-passover-large-img.component.html',
  styleUrls: ['./can-appeal-passover-large-img.component.css']
})
export class CANPassoverLargeAppealComponent {
  preview: any;
  private version: any = {};
