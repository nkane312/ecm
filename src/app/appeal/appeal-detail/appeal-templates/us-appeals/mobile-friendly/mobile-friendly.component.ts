...
@Component({
  selector: 'mobile-friendly-appeal',
  templateUrl: './mobile-friendly.component.html',
  styleUrls: ['./mobile-friendly.component.css']
})
export class MobileFriendlyAppealComponent {
  preview: any;
  private version: any = {};
